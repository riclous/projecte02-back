<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('categoriesId', $product->categoriesId, ['class' => 'form-control' . ($errors->has('categoriesId') ? ' is-invalid' : ''), 'placeholder' => 'Categoriesid']) }}
            {!! $errors->first('categoriesId', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('name') }}
        ...
        <div class="form-group">
            {{ Form::label('tva') }}
            {{ Form::text('tva', $product->tva, ['class' => 'form-control' . ($errors->has('tva') ? ' is-invalid' : ''), 'placeholder' => 'Tva']) }}
            {!! $errors->first('tva', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
